...
class PaidReceiptsTile extends StatefulWidget {
  final SaleOrderDataModel pastOrder;
  // final AllSalesController allSalesCtrlObj;
  final int index;
  PaidReceiptsTile({Key? key, required this.pastOrder, required this.index})
      : super(key: key);

  @override
  State<PaidReceiptsTile> createState() => _PaidReceiptsTileState();
}

class _PaidReceiptsTileState extends State<PaidReceiptsTile> {
  bool valuefirst = false;
  OrderController orderCtrlObj = Get.find<OrderController>();
