...
import '/Config/map_utils.dart';
import '/Pages/OrderMapBloc/order_map_bloc.dart';
import '/Pages/OrderMapBloc/order_map_state.dart';
    ...
    return Scaffold(
      ...
      body: chatOpen
          ...
          : SingleChildScrollView(
              child: Container(
                height:
                    MediaQuery.of(context).size.height - MediaQuery.of(context).padding.top - 105,
